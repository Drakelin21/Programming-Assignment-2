...
ID : 13258895
Date: 29/09/2017
Brief Project Description: Creation of the Assignment 1 with an additional usage of Graphical User Interface.

GitHub URL: https://github.com/Drakelin21/Programming-Assignment-2
...
class ReadingListApp(App):
    ...
    def build(self):
        ...
        :return: self.root
        """
        self.title = "Reading List by Ye Lin Htet"
